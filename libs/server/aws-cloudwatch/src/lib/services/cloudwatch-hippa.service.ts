...
export class CloudwatchHippaService {
    ...
    async writeHippaEvent(event: { accessPoint: string, resourceType: string, resourceIds: string[], accessEmail: string, accessType?: string }): Promise<PutLogEventsCommandOutput> {
